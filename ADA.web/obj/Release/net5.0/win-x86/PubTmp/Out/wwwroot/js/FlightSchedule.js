        ...
        "columns": [

            {
                ...
                "render": function (data) {
                    ...
                    return moment(data.replace(/\Z$/, '')).format('MM/DD/yyy hh:mm a');
                }
            },
            {
                "data": "fltNumber",
            ...
            },
            {
                ...
                "render": function (data) {
                    ...
                    return data == null ? "" : moment(data.replace(/\Z$/, '')).format('MM/DD/YYYY hh:mm a');
                }
            },
            {
                "data": "agent",
        ...
        if (res.status == 200) {
            if (res.data && res.data != null) {
               ...
               var CW= res.data.subManifestColor.split(/([0-9,]+)/);
                ...
                $("#FlightColor1").val(res.data.color.split(',')[0]);
                $("#FlightColor2").val(res.data.color.split(',')[1]);
...
function AddFlight() {
    ...
    if ($("#formFlight").valid()) {
        ...
        var data = {
            FltID: 0,
            "ETD": moment($(FltDateTime).val()).format("YYYY-MM-DD"),
