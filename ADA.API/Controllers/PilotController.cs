...
namespace ADA.API.Controllers
{
    ...
    public class PilotController : ControllerBase
    {
        ...
        private readonly CacheManager<Pilot> cacheManager;
        private readonly string cacheName = "Pilot";

        //private readonly string authenticationCacheName = "Authentication";
        //private readonly double UTCHours = 5.0;
        private readonly IWebHostEnvironment _env;
        public PilotController(IWebHostEnvironment env, IDIUnit unit, IConfiguration confgiuration)
        {
            _configuration = confgiuration;
            _service = unit;
            cacheManager = new CacheManager<Pilot>(unit.memoryCache, unit.pilotService);
            // _loggerService = loggerService;
            _env = env;

        }
        [HttpPost("Add")]
        public Response Add(Pilot obj)
        {
            ...
            try
            {
                ...
                var res = _service.pilotService.Add(obj);
